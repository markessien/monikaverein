  ...
  return (
    <PageLayer className="w-full h-[648px] bg-secondary-100 flex justify-around items-center md:flex-col md:h-auto md:py-8 gap-8">
      <div className="flex flex-col md:items-center">
        <h2 className="text-6xl xl:text-5xl sm:!text-3xl font-bold font-title text-secondary-1000 md:text-center">Donate as a company</h2>
        <p className="text-3xl xl:text-xl text-secondary-800 max-w-[819px] xl:max-w-[519px] mt-8 mb-4 font-title font-bold md:text-center">
