...
const ProgressLabel = ({ percentage }: { percentage: number }) => (
  <div
    className={`absolute flex justify-center items-center text-primary -top-7 left-[${
      percentage - 2
    }%] -translate-x-[3px]`}
  >
    <svg xmlns="http://www.w3.org/2000/svg" className="absolute" width="37" height="38" viewBox="0 0 37 38" fill="none">
      <path
    ...
    <span className="-mt-1 text-sm font-title font-bold">{percentage}%</span>
  </div>
);
