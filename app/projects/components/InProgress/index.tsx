  ...
  return (
    <PageLayer className="grid gap-14" id="in-progress">
      ...
      <Collection
        ...
        list={[
          {
            image: "projects/School%20fee%20funding%20for%20street%20children.jpg?updatedAt=1703043225727",
            amount: {
              expected: 150_000,
              raised: 15_000,
            },
          ...
          {
            image: "projects/need-1.jpeg?updatedAt=1703045123923",
            amount: {
              expected: 150_000,
              raised: 13_000,
            },
      ...
      <Collection
        ...
        list={[
          {
            image: "projects/Construction%20of%20Hostel%20Block.jpg?updatedAt=1703042981666",
            amount: {
              expected: 150_000,
              raised: 15_000,
            },
          ...
          {
            image: "projects/st-pail-library.jpeg?updatedAt=1703045637218",
            amount: {
              expected: 150_000,
              raised: 15_000,
            },
          ...
          {
            image: "projects/Multipurpose%20Assembly%20Hall.JPG?updatedAt=1703043234516",
            amount: {
              expected: 150_000,
              raised: 15_000,
            },
          ...
          {
            image: "projects/Digital%20Lab%20plan.jpg?updatedAt=1703043153859",
            amount: {
              expected: 150_000,
              raised: 15_000,
            },
      ...
      <Collection
        ...
        list={[
          {
            image: "projects/Toys.jpg?updatedAt=1703042993129",
            amount: {
              expected: 150_000,
              raised: 15_000,
            },
          ...
          {
            image: "projects/wheel-chair-donation.png?updatedAt=1703045560662",
            amount: {
              expected: 150_000,
              raised: 15_000,
            },
