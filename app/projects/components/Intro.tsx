...
const Intro = () => {
  return (
    <PageLayer className="flex flex-col justify-center mt-10">
      ...
      <p className="text-xl font-normal font-text text-black text-center mt-16 max-w-[1572px]">
        People's lives can be profoundly and drastically transformed as a result of donations given over time.  We can
