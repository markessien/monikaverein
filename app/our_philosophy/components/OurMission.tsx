    ...
    <PageLayer>
      ...
      <div className="flex justify-between items-center gap-8 mt-8 lg:flex-col">
        <Text size="20" tag="p" className="w-[50%] lg:w-full text-left">
          ...
          we strive to bridge the educational gap and provide every child, regardless of their background or circumstances, with equal opportunities.{" "}
          <br /> Through the establishment of schools, training of teachers, and provision of essential resources, our aim is to build an inclusive
          and high-quality education system that equips students with the knowledge and skills necessary for their success. <br /> By working
