...
const OurHistory = () => {
  return (
    <PageLayer id="history">
      ...
      <p className="text-xl text-center font-text font-normal text-black sm:text-base sm:font-text sm:font-normal mt-6">
...
This starts at a young age. Hence the decision to found a kindergarten. In 1981 this bungalow is rented. It can accommodate 4 group rooms.
